...
### Day 29: October 12, 2019. Saturday

**Today's Progress**:[ Flask Blog ] Learnt how to restructure flask application to use blueprints. Blueprints allow to split up our application into more manageable sections. Moved the creation of  application into its own function. This is called an Application Factory, and it allows to easily create multiple instances of our app with different configurations. <br>
Also learnt how to create custom error pages.


[Tutorial - Blueprints](https://www.youtube.com/watch?v=Wfx4YBzg16s&list=PL-osiE80TeTs4UjLw5MM6OjgkjFeUxCYH&index=11)<br>

**Thoughts:**  

**Link to work:** [Click](https://github.com/sushtend/100-days-of-ml-code/commit/208080b5d01734da8bce75a74c1b3c6216fca2ff)


### Day 28: October 11, 2019. Friday

**Today's Progress**:[ Flask Blog ] Learnt how to send emails to reset a user's password. Users will be able to fill out a form with their email and have a unique token sent to them, and if their token is verified then they will be able to create a new password. We will be using the flask-mail and itsdangerous packages to help  with this. <br>


[Tutorial - Password Reset](https://www.youtube.com/watch?v=vutyTx7IaAI&list=PL-osiE80TeTs4UjLw5MM6OjgkjFeUxCYH&index=10)<br>

**Thoughts:**  There was issue with 'Mailing'<br>(smtplib.SMTPAuthenticationError: smtplib.SMTPAuthenticationError: (534, b'5.7.9 Application-specific password required. Learn more at\n5.7.9  https://support.google.com/mail/?p=InvalidSecondFactor ')). <br> 
Need to re-look again.

**Link to work:** [Click](https://github.com/sushtend/100-days-of-ml-code/commit/29376d990c997de08b0c699e11238059606910b0)

### Day 27: October 10, 2019. Thursday

**Today's Progress**:[ Flask Blog ] Learnt how to add the ability for users to create, update, and delete posts; and how we can prevent users from updating posts that don't belong to them. Also learnt to add user account page so that a user can update their information. Added the ability for a user to upload a profile picture. 

[Tutorial - User Authentication](https://www.youtube.com/watch?v=u0oDDZrDz9U&list=PL-osiE80TeTs4UjLw5MM6OjgkjFeUxCYH&index=8)<br>

**Thoughts:**  

**Link to work:** [Click](https://github.com/sushtend/100-days-of-ml-code/commit/3743e51dcc463a07caeb428729371ef19d6c6e09)


### Day 26: October 9, 2019. Wednesday

**Today's Progress**:[ Flask Blog ] Learnt how to add users to database. Created an authentication system so that users can log in and log out of our application. Used flask-bcrypt and flask-login extensions to help with this.

[Tutorial - User Authentication](https://www.youtube.com/watch?v=CSHx6eCkmv0&list=PL-osiE80TeTs4UjLw5MM6OjgkjFeUxCYH&index=6)<br>

**Thoughts:**  

**Link to work:** [Click](https://github.com/sushtend/100-days-of-ml-code/commit/107f957f7fdcd70f66eaaac8706c9b9e3fe06a5c)



### Day 25: October 7, 2019. Monday

**Today's Progress**:[ Flask Blog ] Learnt how to work with ORM(Object Relationship Maping) using Flask SQL-Alchemy package.
...
**Today's Progress**:[ Flask Blog ] Learnt how to add form registration and user input features to the blog.
...
**Today's Progress**:[ Flask Blog ] Started learning to build web app  using Flask. Built templates  and embedded bootstrap code into the layout template.
