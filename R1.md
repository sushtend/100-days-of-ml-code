...
**Today's Progress**: Learnt how to add users to database. Created an authentication system so that users can log in and log out of our application. Used flask-bcrypt and flask-login extensions to help with this.
